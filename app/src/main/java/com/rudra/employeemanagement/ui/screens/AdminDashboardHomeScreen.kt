...
@Composable
fun AdminDashboardHomeScreen(navController: NavController) {
    ...
    Column(
        ...
        LazyVerticalGrid(
            ...
            items(dashboardItems) { item ->
                AdminDashboardCard(item = item, bottomNavController = navController)
            }
        }
    }
}
...
@Composable
fun AdminDashboardCard(item: BottomNavItem, bottomNavController: NavController) {
    Card(
        modifier = Modifier
            .aspectRatio(1f),
